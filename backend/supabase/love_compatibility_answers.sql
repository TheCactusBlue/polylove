...
create table if not exists
  love_compatibility_answers (
    ...
    explanation text,
    id bigint primary key love_compatibility_answers_pkey generated always as identity not null,
...
create policy "self delete" on love_compatibility_answers for delete using ((creator_id = auth_uid ()));
